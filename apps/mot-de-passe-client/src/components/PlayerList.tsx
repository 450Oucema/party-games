...
export default function PlayerList({ players, showScore = false, recentJoinIds }: Props) {
  return (
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              {showScore && (
                <div className="text-sm font-extrabold text-game-purple/70">{p.score} pts</div>
              )}
            </div>
            {!p.connected && (

...
function makePlayer(id: string, words: string[]): LegacyPlayer {
  return {
    id,
    socketId: `s${id}`,
    name: `Player${id}`,
...
describe('computeResults', () => {
  ...
  it('rare letters mode: unique words get rare letter score + 1 bonus', () => {
    ...
    expect(results[0].totalScore).toBe(11)
  })

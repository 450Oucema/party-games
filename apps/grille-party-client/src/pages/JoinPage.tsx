...
export default function JoinPage() {
  ...
  // Étape 1 : saisie du code (si pas dans l'URL) — étape 2 : saisie du pseudo
  ...
  const submitCode = () => {
    ...
    // navigate so the URL reflects the code (shareable + reload-safe)
  ...
  // ── Saisie du code (pas de code dans l'URL) ───────────────────────────────
  if (step === 'code') {
    return (
      <div className="game-screen flex flex-col items-center justify-center gap-6 p-6 pb-safe">
